        ...
        features: [
          {
            ...
            desc: "Sistema de Login seguro con gestión de usuarios, roles y restricción dinámica de vistas según permisos.",
          },
          {
            title: "Gestión de Productos y Alertas",
            desc: "Catálogo detallado con soporte para categorización, configuración de impuestos y alertas visuales para productos por debajo del stock mínimo.",
          },
          {
            title: "Gestión de Movimientos",
            desc: "Registro de Compras y Ventas que actualizan automáticamente el Stock de los productos en tiempo real.",
          },
          {
            title: "Precios Dinámicos",
            desc: "Gestión avanzada de costos por tipo de relación (Cliente, Proveedor, etc.) con soporte multidivisa (MXN/USD).",
          },
          {
            title: "Gestión de Terceros",
            desc: "Módulos completos para administrar Clientes, Proveedores, Fabricantes, Empresas y Prestadores de Servicios.",
          },
          {
            title: "Reportes PDF",
            desc: "Generación de reportes detallados de compras y ventas en formato PDF.",
          },
          {
            title: "Internacionalización (i18n)",
            desc: "Soporte multiidioma dinámico (Español e Inglés) integrado nativamente en UI, validaciones y reportes.",
          },
          {
            title: "Cloud Backup & Restauración Inteligente",
            desc: "Auto-Respaldo silencioso en la nube al cerrar la app y proceso seguro de restauración en caliente.",
          },
        ],
        technologies: [
          ...
          "Base de Datos: H2 Database (Modo archivo .mv.db) & Flyway",
          "ORM & Sesión: Hibernate / Spring Data JPA & java.util.prefs.Preferences",
          "Reportes e i18n: OpenPDF 1.3.30 & Java ResourceBundle",
        ...
        features: [
          {
            ...
            desc: "Secure login system with user and role management, and dynamic restriction of views based on permissions.",
          },
          {
            title: "Product Management & Alerts",
            desc: "Detailed catalog with categorization, tax configuration, and visual alerts for low-stock products.",
          },
          {
            title: "Movement Management",
            desc: "Complete record of Purchases and Sales that automatically update Stock in real time.",
          },
          {
            title: "Dynamic Pricing",
            desc: "Advanced cost management by relationship type (Client, Supplier, etc.) with multi-currency support (MXN/USD).",
          },
          {
            title: "Third-Party Management",
            desc: "Comprehensive modules to manage Clients, Suppliers, Manufacturers, Competitors, and Service Providers.",
          },
          {
            title: "PDF Reports",
            desc: "Generation of detailed purchase and sales reports in PDF format.",
          },
          {
            title: "Internationalization (i18n)",
            desc: "Dynamic multi-language support (Spanish and English) natively integrated across UI, validations, and reports.",
          },
          {
            title: "Cloud Backup & Smart Restore",
            desc: "Silent background cloud auto-backup on app close and secure hot-restore process.",
          },
        ],
        technologies: [
          "Backend: Java 21 LTS & Spring Boot 3.2.4",
          "UI: JavaFX 23.0.2",
          "BaaS / Cloud: Supabase (Auth and Cloud Storage for backups)",
          "HTTP Client: Spring RestClient",
          "Database: H2 Database (File mode .mv.db) & Flyway",
          "ORM & Session: Hibernate / Spring Data JPA & java.util.prefs.Preferences",
          "Reports & i18n: OpenPDF 1.3.30 & Java ResourceBundle",
          "Testing & CI/CD: JUnit 5, Mockito, GitHub Actions",
          "Tools: Maven, Lombok",
        ],
        repoLink: "https://github.com/vluevano2003/PriceStocker",
